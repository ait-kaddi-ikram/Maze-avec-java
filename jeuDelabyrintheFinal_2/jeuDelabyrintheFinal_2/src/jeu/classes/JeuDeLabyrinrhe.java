...
public class JeuDeLabyrinrhe extends Canvas  {
   ...
   public static final int LARGEUR = 1100; // largeur de fennaitre
   ...
   public  JeuDeLabyrinrhe() throws IOException{
    ...
    private void render() throws IOException{
        ...
        g.fillRect(0,0,widthM*tailleCaze,hiegthM*tailleCaze);
               ...
               gérant.ajouterEntité(new Chemin(1040,200,IDEntité.CHEMIN));
                gérant.ajouterEntité(new Chemin(1053,200,IDEntité.CHEMIN));
                gérant.ajouterEntité(new Chemin(1066,200,IDEntité.CHEMIN));
                //ecrire le score
               score = new Score(1040, 215, IDEntité.SCORE);
